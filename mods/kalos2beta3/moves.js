	...
	"knockoff": {
 	...
 	"lightofruin": {
        ...
        "crosschop": {
                ...
                basePower: 100,
                category: "Physical",
                desc: "Deals damage to one adjacent or non-adjacent target with a 15% chance to flinch it. Makes contact.",
        ...
        "steamcannon": {
                ...
                basePower: 120,
                category: "Special",
                desc: "Deals damage to one adjacent target with a 20% chance to burn it. If the user is frozen, it thaws out just before attacking.",
        ...
        "stoneedge": {
                ...
                basePower: 100,
                category: "Physical",
                desc: "Deals damage to one adjacent or non-adjacent target with a 15% chance to flinch it.",
                shortDesc: "15% chance to flinch the target.",
                id: "stoneedge",
                isViable: true,
                name: "Stone Edge",
        ...
        "hurricane": {
                ...
                basePower: 110,
                category: "Special",
                desc: "Deals damage to one adjacent or non-adjacent target with a 20% chance to confuse it. This move can hit a target using Bounce, Fly, or Sky Drop. If the weather is Rain Dance, this move cannot miss. If the weather is Sunny Day, this move's accuracy is 50%.",
                shortDesc: "20% chance to confuse target. Can't miss in rain.",
                id: "hurricane",
                isViable: true,
                name: "Hurricane",
                pp: 10,
        ...
        "lightbringer": {
                ...
                basePower: 150,
                category: "Special",
                desc: "Deals damage to one adjacent target. If the target lost HP, the user takes recoil damage equal to 1/3 that HP, rounded half up, but not less than 1HP. Makes contact.",
